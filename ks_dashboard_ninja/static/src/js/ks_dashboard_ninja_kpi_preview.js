                ...
                switch (field.ks_data_comparison) {
                    case "None":
                         if (field.ks_multiplier_active){
                            ...
                            item_info['count'] = String(self._onKsGlobalFormatter(count_1 * field.ks_multiplier, field.ks_data_format, field.ks_precision_digits)) + "/" + String(KsGlobalFunction._onKsGlobalFormatter(count_2 * field.ks_multiplier, field.ks_data_format, field.ks_precision_digits));
                         }else{
